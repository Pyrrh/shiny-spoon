...
public class AboutCasting {
    ...
    public void forceIntTypecast() {
        ...
        int b = (int) a;
        assertEquals(b, -2147483648); //overflows the int and therefore is negative
    }
    ...
    public void upcastWithInheritance() {
        ...
        assertEquals(parentReference instanceof Child, true); //because the object it was set to is Child class & they are related
    ...
    public void upcastAndPolymorphism() {
        ...
        assertEquals(parentReference.complain(), "Are we there yet!!"); //it is a reference to the Child instance so calls that method
    }
    ...
    public void downcastWithInheritance() {
        ...
        //explicit cast so the parentReference is of type Parent
        Child childReference = (Child) parentReference; // Or here?
        //explicit cast returns childReference to type Child
    ...
    public void downcastAndPolymorphism() {
        ...
        assertEquals(parent.complain(), "Are we there yet!!"); //because it was cast and set to an instance of Child
    }
    ...
    public void classCasting() {
        try {
            ...
            //NO -- because Object class does not have a .sleep() method
