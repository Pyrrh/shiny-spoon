...
public class AboutObjects {
    ...
    public void allClassesInheritFromObject() {
        ...
        assertEquals(ancestors[0], Foo.class); // the current class is the 0th index & every parent layer goes in order
    ...
    public void objectToString() {
        ...
        //because Java will automatically call Object.toString() otherwise (thanks to inheritance) and getting the
        //string representation of the object itself is rarely the desired outcome
