...
public class AboutBitwiseOperators {
    ...
    public void fullAnd() {
        int i = 1;
        if (true & (++i < 8)) i = i + 1;
        assertEquals(i, 3); // not a for or while loop...only executes once
    }
    ...
    public void dontMistakeEqualsForEqualsEquals() {
        ...
        // ^ I have no idea what this question means, what is "with a twist"??
    }
    ...
    public void aboutBitShiftingLeftShift() {
        ...
        assertEquals(leftShift, 0x00000000);
    }
    ...
    public void aboutBitShiftingRightUnsigned() {
        ...
        assertEquals(rightShiftNegativeStaysNegative, 0xf8000000); // shift, then invert sign
