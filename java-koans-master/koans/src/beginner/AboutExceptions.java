...
public class AboutExceptions {
    ...
    private String returnStatementsEverywhere(StringBuilder whatHappened) {
        try {
            ...
            // because you do not want to take further action when an exception is thrown
            return "from finally";
        }
    }
    ...
    public void passArgumentValidationWithAnIllegalArgumentException() {
        ...
        assertEquals(s, "5"); // assigning integer 5 to a string variable auto-casts it to string
    }
